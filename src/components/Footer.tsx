      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-white mb-6 max-w-md font-bold">
            ...
            <div className="flex space-x-4">
              <button
                ...
                className="p-2 bg-gray-800 hover:bg-gray-600 rounded-lg transition-colors duration-200"
                title="GitHub"
              >
              ...
              {['About', 'Experience', 'Certifications', 'Featured Work', 'Contact'].map((item) => (
                <li key={item}>
                  <button
                    ...
                    className="text-white hover:text-gray-300 transition-colors duration-200 font-bold"
                  >
                    {item}
                  </button>
                </li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-white text-sm mt-4 md:mt-0 font-bold">
